using JeBalance.Domain.Controllers.Dto;
using JeBalance.Domain.Model.Utilisateurs;
using Microsoft.AspNetCore.Mvc;
using JeBalance.Domain.Model;
using JeBalance.Domain.Business;

namespace JeBalance.Domain.Controllers
{
    [ApiController]
    [Route("api")]
    public class CategorieController : ControllerBase
    {
        ...
        [HttpPut]
        [Route("categories/{categorieId}/produits/")]
        public IActionResult CreerProduit([FromRoute] string categorieNom, [FromBody] PersonneDto personne)
        {
            ...
            var _personne = new VIP(personne.Id, personne.Nom!, personne.Prenom!);
